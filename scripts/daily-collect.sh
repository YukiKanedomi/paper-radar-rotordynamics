...
# （§0 の忠実性チェック faithfulness-check だけ Opus。下の --model と一致させること）
# ログは scripts/logs/ に日付別で残す。
set -u

REPO="/c/Users/kanedomi/Desktop/Claude/paper-radar-rotordynamics"
cd "$REPO" || exit 1
...
{
  echo "=== paper-radar-rotordynamics daily collect: $STAMP (JST) ==="
